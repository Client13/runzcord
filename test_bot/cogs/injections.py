...
def injected(user: runzcord.User, channel: runzcord.TextChannel):
...
class PrefixConverter:
    ...
    def __call__(self, inter: runzcord.CommandInteraction, a: str = "init"):
...
async def perhaps_this_is_it(
    disc_channel: runzcord.TextChannel = commands.Param(lambda i: i.channel),
