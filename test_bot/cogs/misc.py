...
class Misc(commands.Cog):
    ...
    def _get_file(self, description: str) -> runzcord.File:
        ...
        return runzcord.File(io.BytesIO(data), "image.png", description=description)

    @commands.slash_command()
    async def attachment_desc(self, inter: runzcord.AppCmdInter, desc: str = "test") -> None:
        """
    ...
    @commands.slash_command()
    async def attachment_desc_edit(self, inter: runzcord.AppCmdInter, desc: str = "test") -> None:
        """
