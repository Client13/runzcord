import runzcord
from runzcord.enums import TextInputStyle
...
class Modals(commands.Cog):
    ...
    async def create_tag(self, inter: runzcord.AppCmdInter) -> None:
        """Sends a Modal to create a tag."""
        await inter.response.send_modal(modal=MyModal())

    @commands.slash_command()
    async def create_tag_low(self, inter: runzcord.AppCmdInter) -> None:
        ...
        modal_inter: runzcord.ModalInteraction = await self.bot.wait_for(
            "modal_submit",
