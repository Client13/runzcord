...
class SlashCommands(commands.Cog):
    ...
    async def hello(self, inter: runzcord.CommandInteraction):
        await inter.response.send_message("Hello world!")

    @commands.slash_command()
    async def auto(self, inter: runzcord.CommandInteraction, mood: str):
        """
    ...
    async def test_autocomp(self, inter: runzcord.CommandInteraction, string: str):
        return ["XD", ":D", ":)", ":|", ":("]
    ...
    @commands.slash_command()
    async def guild_only(self, inter: runzcord.GuildCommandInteraction, option: str = None):
    ...
    @commands.slash_command()
    async def largenumber(self, inter: runzcord.CommandInteraction, largenum: commands.LargeInt):
