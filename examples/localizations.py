...
import runzcord
from runzcord import Localized, OptionChoice
from runzcord.ext import commands

bot = commands.Bot(command_prefix=commands.when_mentioned)


# For more details, see https://docs.runzcord.dev/en/latest/ext/commands/slash_commands.html#localizations
...
async def game_autocomp(inter: runzcord.CommandInteraction, string: str):
