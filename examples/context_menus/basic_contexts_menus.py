...
async def avatar(inter: runzcord.ApplicationCommandInteraction, user: runzcord.User):
    emb = runzcord.Embed(title=f"{user}'s avatar")
...
async def reverse(inter: runzcord.ApplicationCommandInteraction, message: runzcord.Message):
