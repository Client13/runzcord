...
This is the documentation for runzcord, a library for Python to aid
in creating applications that utilise the Discord API.

Prerequisites
---------------

runzcord works with Python 3.8 or higher. Support for earlier versions of Python
...
To get voice support, you should use ``runzcord[voice]`` instead of ``runzcord``, e.g. ::

    python3 -m pip install -U runzcord[voice]
...
runzcord revolves around the concept of :ref:`events <discord-api-events>`.
