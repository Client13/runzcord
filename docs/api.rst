...
The following section outlines the API of runzcord.
...
.. autofunction:: runzcord.opus.load_opus

.. autofunction:: runzcord.opus.is_loaded
...
overriding the specific events. For example: ::
    ...
    class MyClient(runzcord.Client):
...
.. function:: on_message_interaction(interaction)
    ...
    .. warning::
        ...
        with the :class:`~runzcord.ui.View` instead as it provides a nicer user experience.
...
.. function:: on_button_click(interaction)
    ...
    .. warning::
        ...
        Consider using the callbacks associated with the :class:`~runzcord.ui.View` instead.
...
.. function:: on_application_command(interaction)
    ...
    .. warning::
        ...
        If you decide to override this event and are using :class:`~runzcord.ext.commands.Bot` or related types,
        make sure to call :func:`Bot.process_application_commands <runzcord.ext.commands.Bot.process_application_commands>`
...
.. function:: on_application_command_autocomplete(interaction)
    ...
    .. warning::
        If you decide to override this event and are using :class:`~runzcord.ext.commands.Bot` or related types,
        make sure to call :func:`Bot.process_app_command_autocompletion <runzcord.ext.commands.Bot.process_app_command_autocompletion>`
...
.. autofunction:: runzcord.utils.find

.. autofunction:: runzcord.utils.get

.. autofunction:: runzcord.utils.snowflake_time

.. autofunction:: runzcord.utils.oauth_url

.. autofunction:: runzcord.utils.remove_markdown

.. autofunction:: runzcord.utils.escape_markdown

.. autofunction:: runzcord.utils.escape_mentions

.. autofunction:: runzcord.utils.resolve_invite

.. autofunction:: runzcord.utils.resolve_template

.. autofunction:: runzcord.utils.sleep_until

.. autofunction:: runzcord.utils.utcnow

.. autofunction:: runzcord.utils.format_dt

.. autofunction:: runzcord.utils.as_chunks

.. autofunction:: runzcord.utils.search_directory

.. autofunction:: runzcord.utils.as_valid_locale
...
runzcord offers support for creating, editing, and executing webhooks through the :class:`Webhook` class.
...
.. attributetable:: runzcord.abc.Snowflake

.. autoclass:: runzcord.abc.Snowflake()
    :members:

User
~~~~~

.. attributetable:: runzcord.abc.User

.. autoclass:: runzcord.abc.User()
    :members:

PrivateChannel
~~~~~~~~~~~~~~~

.. attributetable:: runzcord.abc.PrivateChannel

.. autoclass:: runzcord.abc.PrivateChannel()
    :members:

GuildChannel
~~~~~~~~~~~~~

.. attributetable:: runzcord.abc.GuildChannel

.. autoclass:: runzcord.abc.GuildChannel()
    :members:

Messageable
~~~~~~~~~~~~

.. attributetable:: runzcord.abc.Messageable

.. autoclass:: runzcord.abc.Messageable()
    :members:
    :exclude-members: history, typing

    .. automethod:: runzcord.abc.Messageable.history
        :async-for:

    .. automethod:: runzcord.abc.Messageable.typing
        :async-with:

Connectable
~~~~~~~~~~~~

.. attributetable:: runzcord.abc.Connectable

.. autoclass:: runzcord.abc.Connectable()
...
.. attributetable:: runzcord.ui.View

.. autoclass:: runzcord.ui.View
    :members:

ActionRow
~~~~~~~~~~

.. attributetable:: runzcord.ui.ActionRow

.. autoclass:: runzcord.ui.ActionRow
    :members:

Item
~~~~~~~

.. attributetable:: runzcord.ui.Item

.. autoclass:: runzcord.ui.Item
    :members:

WrappedComponent
~~~~~~~~~~~~~~~~

.. attributetable:: runzcord.ui.WrappedComponent

.. autoclass:: runzcord.ui.WrappedComponent
    :members:

Button
~~~~~~~

.. attributetable:: runzcord.ui.Button

.. autoclass:: runzcord.ui.Button
    :members:
    :inherited-members:

.. autofunction:: runzcord.ui.button

Select
~~~~~~~

.. attributetable:: runzcord.ui.Select

.. autoclass:: runzcord.ui.Select
    :members:
    :inherited-members:

.. autofunction:: runzcord.ui.select

Modal
~~~~~

.. attributetable:: runzcord.ui.Modal

.. autoclass:: runzcord.ui.Modal
    :members:

TextInput
~~~~~~~~~

.. attributetable:: runzcord.ui.TextInput

.. autoclass:: runzcord.ui.TextInput
    :members:
...
.. autoexception:: runzcord.opus.OpusError

.. autoexception:: runzcord.opus.OpusNotLoaded
